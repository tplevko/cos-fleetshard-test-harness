...
All original contributions to cos-fleetshard-test-harness are licensed under the
...
All submissions, including submissions by project members, need to be reviewed by a cos-fleetshard-test-harness committers before being merged.
...
### Continuous Integration
 ...
 cos-fleetshard-test-harness project CI is based on GitHub Actions, which means that everyone has the ability to automatically execute CI in their forks as part of the process of making changes. We ask that all non-trivial changes go through this process, so that the contributor gets immediate feedback, while at the same time keeping our CI fast and healthy for everyone.
